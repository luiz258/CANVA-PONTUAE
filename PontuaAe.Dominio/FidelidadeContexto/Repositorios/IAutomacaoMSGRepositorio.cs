...
namespace PontuaAe.Dominio.FidelidadeContexto.Repositorios
{
    public interface IAutomacaoMSGRepositorio : IMensagem<Mensagem>
    {
     ...
     Task<IEnumerable<ObterAutomacaoTipoUltimaFide>> ObterContatosQueVisitaramAposUltimaFidelizacao(int TempoPorDia, string Segmentacao, string SegCustomizado, int IdEmpresa);
